function [] = sweep_params_NoMCP(paramToSweep)
...
for ii = 1:length(sweep{1,2})
    startValue=get(PduParams_NoMCP,sweep{1,1});
...
%     plot(sweep{1,2}(ii), mean(Acyto), 'xr')
    ...
    legend('numerical PMCP edge','numerical AMCP edge','numerical PMCP center','numerical AMCP center','Location','southeast')
